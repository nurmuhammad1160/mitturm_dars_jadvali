...
// Lokal API endpoint (Netlify'da ishlamaydi, /.netlify/functions/schedule ishlaydi)
app.get('/api/schedule', (req, res) => {
    res.json(schedule);
});

// Statik fayllarni (HTML, CSS, JS) ulashish (Lokal test uchun)
app.get('/', (req, res) => {
...
// Serverni ishga tushirish (Lokal test uchun)
app.listen(PORT, () => {
    console.log(`Lokal server http://localhost:${PORT} manzilida ishga tushdi`);
});